    ...
    <div class="max-w-7xl mx-auto pt-2 xl:mb-10 lg:mb-10 md:mb-8 sm:mb-3 lt:mb-3">
        ...
        @if(count($searchResult) > 0 )
            ...
            @foreach($searchResult as $post)
                ...
                @if($post['status'])
                    <div
                        class="flex justify-start py-2 xl:flex-row lg:flex-row md:flex-row sm:flex-col lt:flex-col items-center border-b-2 border-dotted hover:border-solid hover:border-white last:border-b-0 border-gray-200 hover:bg-gray-100 duration-200 ease-linear">
                        ...
                        <div class="xl:w-4/5 lg:w-4/5 md:w-4/5 sm:w-full lt:w-full p-2">
                            <a href="{{ route('showItem', ['id' => $post['id']]) }}">
