    ...
    <div class="w-full">
        <div class="w-full mb-20">
            ...
            <div class="w-full bg-black/40 border-t-6 end-0 py-10 mt-16">
                <div class="uppercase text-4xl text-white w-full  px-14">
                    <h1 class="font-bold uppercase xl:text-6xl lg:text-6xl md:text-4xl sm:text-2xl lt:text-2xl text-center ">{{ __('Powder Manufacturer') }}</h1>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto mb-5">
            <div class=" flex xl:flex-row lg:flex-row md:flex-col sm:flex-col lt:flex-col justify-around">
                <div class="xl:w-2/4 lg:w-2/4 md:w-full sm:w-full lt:w-full p-2 pl-14">
                    <h3 class="uppercase text-2xl font-medium my-8 text-left text-dark-green">
                        {{ __('Popular Powder Manufacturing Categories') }}
                    </h3>
                    <ul class="pl-10 list-disc text-xl">
                        <li>Protein Powders</li>
                        <li>Greens Powders</li>
                        <li>Pre & Post Workout Powders</li>
                        <li>Post Workout Powders</li>
                        <li>Sports Nutrition</li>
                        <li>Collagen (Bovine & Marine)</li>
                        <li>Electrolytes and Hydration</li>
                        <li>Vitamin Powders</li>
                        <li>And more…</li>
                    </ul>
                </div>
                <div class="xl:w-2/4 lg:w-2/4 md:w-full sm:w-full lt:w-full p-2 pl-14">
        ...
        <div class="max-w-7xl mx-auto xl:mb-10 lg:mb-10 md:mb-5 sm:mb-2 lt:mb-2">
            <div class="w-full p-6">
                <div class="text-center">
                    <p>There are many ways to combine ingredients in a formulation. If you have a question about how
                        to
                        best combine ingredients, we will be glad to help. We can also provide guidance on which
                        ingredients work well together and which ones may not be compatible. Contact us today to
                        learn
                        more about formulating your own products.</p>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto mb-20">
            <div class="w-full flex flex-col items-center">
                <div class="w-5/6 text-center pb-10">
                    <x-h2>{{ __('Powder Supplement Ingredients & Flavors: Everything You Need to Kno') }}</x-h2>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto mt-5">
            <div
                    ...
                    <div>
                        ...
                        <div class="p-3">
                            <p>Our extensive supply chain gives us access to nearly all types of packaging. If you're
                                ...
                                whether
                                it's packets, bottles, or something else entirely. Plus, if you want your container
                                boxed,
                                we can handle that too. And when it comes to label design, you can choose whatever look
                                you
                                want.
                                Once you've decided on your packaging, we'll verify your choices and start the
                                manufacturing
                                process.</p>
                        </div>
                    </div>
                ...
                <div class="xl:w-1/3 lg:w-1/3 md:w-1/3 sm:w-full lt:w-full flex flex-col-reverse">
                    ...
                    <div>
                        <h3 class="uppercase text-xl font-medium text-center text-dark-green">
                            {{ __('Step 2: We Make Your Powder') }}
                        </h3>
                        <div class="p-3">
                            <div>During this process, these are the steps that take place:</div>
                    ...
                    <div>
                        ...
                        <div class="p-3">
                            <p>Once your order is complete, we carefully test it to ensure that it meets our high
                                ...
                                its
                                progress.
                                You can be confident that the ingredients in your shipment are taken into account when
                                deciding how to ship it, in order to preserve the integrity of the substances.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto mt-2 mb-5">
            <div
                class="flex xl:flex-row lg:flex-row md:flex-row sm:flex-col lt:flex-col justify-items-stretch pt-2">
                <div class="xl:w-2/4 lg:w-2/4 md:w-2/4 sm:w-full lt:w-full p-6">
                    <div class="p-3">
                        <img src="{{ asset('img/facility/facility-8.png') }}" alt="facility-8">
                    </div>
                    <h4 class="uppercase text-2xl font-medium mt-10 p-3 text-center text-dark-green">
                        {{ __('Frequently Asked Questions About Private Label Powder Manufacturing') }}
                    </h4>
                    <div class="">
                        <div>These are some of the main questions that people have about the process:</div>
                        <ul class="list-disc pl-5">
                            <li>Are the ingredients in your supplements safe and of high quality?</li>
                            ...
                            have
                            strict testing procedures in place, and our facilities can utilize the GMPs of the
                            certification authorities that we work with. This allows us to thoroughly test
                            ingredients
                ...
                <div class="xl:w-2/4 lg:w-2/4 md:w-2/4 sm:w-full lt:w-full p-6">
                    <div class="p-3">
                        <img src="{{ asset('img/facility/facility-9.png') }}" alt="facility-9">
                    </div>
                    <h4 class="uppercase text-2xl font-medium mt-10 p-3 text-center text-dark-green ">
                        {{ __('Why Choose PuroVite for Powder Manufacturing?') }}
                    </h4>
                    <div class="text-justify">
