            ...
            <div class="flex lg:flex-row xl:flex-row md:flex-row sm:flex-col lt:flex-col">
                <div class="flex flex-col items-center xl:w-1/2 lg:w-1/2 md:w-1/2 sm:w-full lt:w-full p-5 pb-0">
                    ...
                    <div class="w-full sm:text-justify lt:text-justify">
                        There are many benefits to choosing a capsule over other delivery forms for your supplements.
                        Capsules allow for rapid delivery of your supplement without any unpleasant tastes (off-putting
                        bitterness, for instance) that some individual ingredients have. They also provide more
                        effective
                        absorption, delivering the same health benefits using smaller doses. By working with a reputable
                        and
                        experienced capsule manufacturer, you can be sure that your supplements will be of the highest
                        quality and potency.
                    </div>
                    <h3 class="uppercase xl:text-2xl lg:text-2xl md:text-xl sm:text-xl lt:text-xl font-medium my-5 pt-5 xl:text-left lg:text-left md:text-center sm:text-center lt:text-center text-dark-green">
                        {{ __('There are many other benefits of capsules:') }}
                    </h3>
                    <div>
                        <ul class="list-disc pl-10">
                            <li>Easy to swallow</li>
                            <li>Minimal odors</li>
                            <li>More accurate dosages</li>
                            <li>Deliver types of supplements that tablets can’t</li>
                            <li>Visually stunning (hard shell capsules can be customized with brand logos)</li>
                            <li>Lower production and R&D costs than gummies, liquids, and tablets</li>
            ...
            <div class="xl:w-1/3 lg:w-1/3 md:w-1/3 sm:w-full lt:w-full p-6">
                ...
                <div class="text-justify xl:mb-0 lg:mb-0 md:mb-5 sm:mb-5 lt:mb-5">
                    <p>SOFT GELS: If you're looking for a quick and easy way to take your supplements, then soft
                        ...
                        perfect for formulations that require rapid delivery.</p>
                </div>
            </div>
            <div class="xl:w-1/3 lg:w-1/3 md:w-1/3 sm:w-full lt:w-full p-6">
                <div class="xl:mb-0 lg:mb-0 md:mb-5 sm:mb-5 lt:mb-5 xl:text-left lg:text-left md:text-center sm:text-center lt:text-center">
                ...
                <div class="text-justify xl:mb-0 lg:mb-0 md:mb-5 sm:mb-5 lt:mb-5">
                    <p>CAPSULES are an excellent choice for those looking for a 100% vegetarian option that works
                        ...
                        HPMC, without any animal by-products, BSE, GMOs, or gelatin. It is also gluten- and
                        starch-free.
                        Pullulan: This water-soluble polysaccharide is produced by the fermentation of sugar and
                ...
                <div class="text-justify xl:mb-0 lg:mb-0 md:mb-5 sm:mb-5 lt:mb-5">
                    <p>HARD SHELLS are formed from two shells with the formulation in the middle. They're more
                        ...
                        is adequately absorbed and distributed. Whether you're looking for a simple way to take your
                        daily vitamins or need a more complex formulation for a chronic condition, hard-shell
                        capsules are an excellent choice. </p>
                </div>
            </div>
            <div class="xl:w-1/3 lg:w-1/3 md:w-1/3 sm:w-full lt:w-full p-6">
                <div class="xl:mb-0 lg:mb-0 md:mb-5 sm:mb-5 lt:mb-5 xl:text-left lg:text-left md:text-center sm:text-center lt:text-center">
                ...
                <div class="text-justify xl:mb-0 lg:mb-0 md:mb-5 sm:mb-5 lt:mb-5">
                    <p>LIQUID & BEADLET CAPSULES: Absorption is vital in liquid and beadlet capsules. These capsules
                        ...
                        processed by the body. </p>
                </div>
            </div>
        </div>
    </div>
    <div class="max-w-7xl mx-auto py-8 mb-10">
        <div class="flex flex-row p-10">
            <div class="flex flex-col">
                <div class="p-2">
                    <img src="{{ asset('img/services/services-2.png') }}" alt="services-2">
                </div>
                <div class="p-2">
            ...
            <div class="flex flex-col">
                <div class="p-2">
                    <img src="{{ asset('img/services/services-5.png') }}" alt="services-5">
                </div>
                <div class="p-2">
                    <img src="{{ asset('img/services/services-6.png') }}" alt="services-6">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="w-full flex xl:flex-row lg:flex-row md:flex-row sm:flex-col lt:flex-col">
            <div class="lg:w-1/2 xl:w-1/2 md:w-1/2 sm:w-full lt:w-full p-6 text-justify">
                <p>As your dedicated capsule manufacturer, we’ll use state-of-the-art facilities and high capacity
                    ...
                    ensure a smooth, efficient process.</p><br>
                <p>Our state-of-the-art blenders make it easy to blend and weigh large quantities of capsules quickly
                    and efficiently. No matter the size of your order, we can rapidly manufacture and deliver your
            ...
            <div class="lg:w-1/2 xl:w-1/2 md:w-1/2 sm:w-full lt:w-full p-6 text-justify">
                ...
                <p>Our priority is quality assurance. We conduct an extensive product testing process inhouse to ensure
                    your finished product meets all safety standards and regulations while fulfilling your customers’
                    needs. With the help of our R&D and Quality Control teams, you can be confident that your products
            ...
            <div class="xl:w-2/4 lg:w-2/4 md:w-2/4 sm:w-full lt:w-full p-6">
                ...
                <div class="text-justify xl:mb-0 lg:mb-0 md:mb-5 sm:mb-5 lt:mb-5">
                    <p>The right package is more than just a container for your product. It hints at the future your
                        ...
                        confident about their purchase.</p><br>
                    <p>Your product's packaging is important for more than just marketing purposes. Your label
                        should clearly display the ingredients, dosage requirements, and how to refill. We offer a
                        range of packaging to fit your needs:</p><br>
                </div>
                <div class="">
                    <ul class="pl-10 list-disc">
                        <li>PET and HDPE Bottles</li>
                        <li>Plastic and Glass</li>
                        <li>Jars, Oblongs, Packers</li>
                        <li>Blister Packs</li>
                        <li>Stick Packs</li>
                        <li>Sachets</li>
                        <li>Cartons</li>
                        <li>Folding displays and boxes</li>
                        <li>And more options to choose from…</li>
                    </ul>
                    <br>
                </div>
                <div class="text-justify xl:mb-0 lg:mb-0 md:mb-5 sm:mb-5 lt:mb-5">
            ...
            <div class="xl:w-2/4 lg:w-2/4 md:w-2/4 sm:w-full lt:w-full p-6">
                ...
                <div class="text-justify xl:mb-0 lg:mb-0 md:mb-5 sm:mb-5 lt:mb-5">
                    <p>CAPSULES are an excellent choice for those looking for a 100% vegetarian option that works
                        ...
                        Pullulan: This water-soluble polysaccharide is produced by the fermentation of sugar and
                        starch using the fungus Aerobasidum pullulans. It is similar to the
                        HPMC capsule but 100% natural.</p><br>
                </div>
                <div class="">
                    <ul class="pl-10 list-disc">
                        <li>Conduct Anti-caking</li>
                        <li>Use the Ideal Fill Weight</li>
                        <li>Perform Odor-Masking</li>
                        <li>Ensure Powder Flowability</li>
                        <li>Clean, Polished Capsules</li>
    ...
    <div class="max-w-7xl mx-auto mt-10">
        <div class="flex xl:flex-row lg:flex-row md:flex-col sm:flex-col lt:flex-col">
            <div class="xl:w-1/2 lg:w-1/2 md:w-full sm:w-full lt:w-full p-5">
                ...
                <div class="w-full pt-5 sm:text-justify lt:text-justify">
                    At PuroVite, we understand that you've put a lot of time and effort into creating a custom
                    formulation
                    that you know will be successful in your market. We don't want your hard work to go to waste, so
                    we're
                    committed to being your partner from the moment you receive your quote until the product arrives at
                    your
                    door.
                    With PuroVite, you'll never be in the dark. We'll work with you to create the custom product you
                    need.
                    We're dedicated to providing the best possible service and support, so you can focus on making your
                    business a success.
                    If you're ready to get started, call us today! We can't wait to help you take your business to the
                    next
                    level.
                </div>
            </div>
