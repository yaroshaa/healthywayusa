<header class="w-full fixed top-0 z-20 duration-200 ease-linear"
        x-data="{navChange:false}"
        @scroll.window="navChange = (window.pageYOffset > 50) ? true : false"
        :class="navChange ? 'h-14 bg-nav-green/80' : 'h-20 bg-transparent'">
    <div class="max-w-7xl mx-auto">
        <nav x-data="{ open: false }" class="bg-transparent">
            <div class="mx-auto transition-all duration-200 ease-in-out"
                 x-data="{navChange:false}"
                 @scroll.window="navChange = (window.pageYOffset > 50) ? true : false"
                 :class="navChange ? 'py-2' : 'py-4'">
                <div class="flex justify-between h-10">
                    <div class="flex">
                        <div class="flex-shrink-0 flex items-center pr-5 xl:pl-2 lg:pl-2md:pl-2 sm:pl-2 lt:pl-2">
                            <a href="{{ route('home') }}">
                                <x-application-logo class="block h-16 w-auto fill-current text-gray-600 "/>
                            </a>
                        </div>
                        <div
                            class="z-20 sm:hidden md:hidden lt:hidden lg:inline-flex xl:inline-flex xl:space-x-8 lg:space-x-2.5 sm:-my-px sm:ml-5">
                    ...
                    @if (Auth::user())
                        <!-- Settings Dropdown -->
                        <div
                            class="lg:inline-flex xl:inline-flex md:hidden sm:hidden lt:hidden space-x-8 sm:-my-px sm:ml-10 sm:flex xl:pt-1 lg:pt-1 ">
                            <x-dropdown align="right" width="48">
                                <x-slot name="trigger">
                                    <button
                                        ...
                                        <div class="ml-1">
                                            <svg class="h-10 w-10" viewBox="0 0 45 45" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <g clip-path="url(#clip0_367_381)">
                                                    <path
                                                        d="M22.5 28.125C28.7132 28.125 33.75 23.0882 33.75 16.875C33.75 10.6618 28.7132 5.625 22.5 5.625C16.2868 5.625 11.25 10.6618 11.25 16.875C11.25 23.0882 16.2868 28.125 22.5 28.125Z"
                                                        stroke="white" stroke-width="4" stroke-miterlimit="10"/>
                                                    <path
                                                        d="M5.44727 37.9671C7.17618 34.9745 9.66217 32.4896 12.6555 30.762C15.6488 29.0344 19.0441 28.125 22.5002 28.125C25.9563 28.125 29.3515 29.0346 32.3448 30.7622C35.3381 32.4899 37.824 34.9749 39.5529 37.9675"
                                    ...
                                    <button
                                        ...
                                        <div class="ml-1">
                                            <svg class="h-10 w-10" viewBox="0 0 45 45" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M20.3906 35.1562C28.5455 35.1562 35.1562 28.5455 35.1562 20.3906C35.1562 12.2358 28.5455 5.625 20.3906 5.625C12.2358 5.625 5.625 12.2358 5.625 20.3906C5.625 28.5455 12.2358 35.1562 20.3906 35.1562Z"
                                                    stroke="white" stroke-width="4" stroke-linecap="round"
                                                    stroke-linejoin="round"/>
                                                <path d="M30.8308 30.832L39.3739 39.3751" stroke="white"
                                ...
                                <x-slot name="content">
                                    <form method="POST" action="{{ route('search') }}">
                                        ...
                                        <div class="flex flex-row bg-white p-0 m-0">
                                            <x-text-input id="search" class="ml-1  w-4/5" type="text" name="search"
                                                          :value="old('search')"/>
