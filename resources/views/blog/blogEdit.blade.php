                ...
                <form method="POST" action="{{ route('postupdate', ['id' => $data['id']]) }}"
                        ...
                        <select id="language_id"
                            ...
                            @foreach($languages as $language)
                                <option value="{{$language->id}}"
                                        @if($language->id ===  $data['language_id']) selected @endif >{{$language->name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-area id="content" class="block mt-1 w-full" type="text" name="content"
                                     required>{{ $data['content'] }}</x-text-area>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="meta_description" class="block mt-1 w-full" type="text"
                                      name="meta_description" :value="$data['meta_description']" required/>
